            ...
            <AiOutlineMenu onClick={handleNav} className='absolute top-4 right-4 z-[99] md:hidden' />
            {
                ...
                <div className="md:block hidden fixed top-[25%] z-10">
                    <div className="flex flex-col">
                        ...
                        <a onClick={handleNav} href="#work" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300">
                            <GrProjects size={20} />
                        </a>
